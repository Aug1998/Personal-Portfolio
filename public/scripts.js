...
function checkSection() {
  ...
  //about
  if (
    windowTop >= $(".about").offset().top &&
    windowTop < $(".about").offset().top + $(".about").height()
  ) {
    $("*").removeClass("nav_active");
  ...
  //services
  if (
    windowTop >= $(".services").offset().top &&
    windowTop < $(".services").offset().top + $(".services").height()
  ) {
    $("*").removeClass("nav_active");
  ...
  //portfolio
  if (
    windowTop >= $(".portfolio_section").offset().top &&
    windowTop <
      $(".portfolio_section").offset().top + $(".portfolio_section").height()
  ) {
    $("*").removeClass("nav_active");
  ...
  //contact
  if (
    windowTop >= $(".contact_section").offset().top &&
    windowTop <
      $(".contact_section").offset().top + $(".contact_section").height()
  ) {
    $("*").removeClass("nav_active");
