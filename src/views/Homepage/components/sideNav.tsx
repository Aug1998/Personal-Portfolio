...
export default function SideNav() {
  return (
    <div>
           <div className="exit_sidenav"></div>
            <aside>
            <div className="sidenav">
                <div className="sidenav_brand">
                    <svg className="logo_svg logo_sidenav" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 88.27 96.31">
                ...
                <div><a className="sidenav_btn home_btn active" href="#">Inicio</a></div>
                <div><a className="sidenav_btn services_btn" href="#">Servicios</a></div>
                <div><a className="sidenav_btn portfolio_btn" href="#">Portfolio</a></div>
                <div><a className="sidenav_btn about_btn" href="#">Sobre mí</a></div>
                <div><a className="sidenav_btn contact_btn" href="#">Contacto</a></div>
            </div>
            </aside>
    </div>
  )
